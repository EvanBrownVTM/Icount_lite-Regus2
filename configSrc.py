...
##### Location specific #####
camera_map = {"cam0": 23797015, "cam1": 23874368, "cam2": 23881564} # Format{"cam0": 23***, "cam1": 23***, "cam2":23***}
activate_arch = True
sms_alert = False
thresh_cv_time = 70
...
cls_dict = {0: 'Coca Cola 20z', 1: 'Gatorade 12oz', 2: 'Monster Regular', 3: 'Diet Coke (SF)', 4: 'Dasani Water 16 oz', 5: 'Monster White', 6: 'Doritos', 7: 'Gold Peak', 8: 'Lays Baked', 9: 'Sun Chips', 10: 'Vickies'} 
