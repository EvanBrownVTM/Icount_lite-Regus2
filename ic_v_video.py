...
from utils.front_cam_solver import FrontCam
from utils.side_cam_solver import SideCam
...
display_mode = True
pika_flag = False
camera_dirs = ['/home/evan/Datasets/Subway-6item/bad-detections/cam0_rgb',
			   '/home/evan/Datasets/Subway-6item/bad-detections/cam1_rgb',
			   '/home/evan/Datasets/Subway-6item/bad-detections/cam2_rgb']
...
cam0_solver = FrontCam('cam0', 'utils/cam0_zones_action.npz')
cam1_solver = SideCam('cam1', 'utils/cam1_zones_action.npz')
cam2_solver = SideCam('cam2', 'utils/cam2_zones_action.npz')
...
while True:
	...
	if door_state == 'DoorOpened':
		...
		if cameraContextValue == 0:
			frame0 = cv2.resize(np.uint8(frame), (frame_size, frame_size))
			check_list[0] = True
			if archive_flag:
				data = {
			...
			frame1 = cv2.resize(np.uint8(frame), (frame_size, frame_size))
			...
			frame2 = cv2.resize(np.uint8(frame), (frame_size, frame_size))
